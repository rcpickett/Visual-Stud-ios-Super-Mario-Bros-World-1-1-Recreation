...
{
    class SmallMarioRunningLeftState : IPlayerState
    {
        ...
        public SmallMarioRunningLeftState(Mario m)
        {
            sprite = (MarioRunningSprite)SpriteFactory.CreateSmallMarioRunningLeftSprite();
            mario = m;
        }
