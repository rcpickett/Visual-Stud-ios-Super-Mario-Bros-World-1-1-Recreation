...
{
    public class SmallMarioSwimIdleRightState : IPlayerState
    {
        ...
        public SmallMarioSwimIdleRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateSmallMarioSwimIdleRightSprite();
        }
