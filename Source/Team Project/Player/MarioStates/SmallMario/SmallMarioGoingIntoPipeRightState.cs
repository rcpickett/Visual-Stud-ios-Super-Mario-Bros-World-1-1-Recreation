...
{
    public class SmallMarioGoingIntoPipeRightState : IPlayerState
    {
        ...
        public SmallMarioGoingIntoPipeRightState(Mario m, Vector2 newL, Vector2 newCL)
        {
            SoundManager.PlayMarioPipeOrPowerDownSound();
            mario = m;
            sprite = SpriteFactory.CreateSmallMarioRunningRightSprite();
        ...
        public void Update(GameTime gameTime)
        {
            ...
            {
                mario.Location = new Vector2(mario.Location.X + 2, mario.Location.Y);
            }
            if (timer >= 1000)
            {
                ...
                mario.State = new SmallMarioComingOutOfPipeState(mario);
            }
