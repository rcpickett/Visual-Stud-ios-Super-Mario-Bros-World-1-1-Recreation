...
{
    public class SmallMarioTurningRightState : IPlayerState
    {
        ...
        public SmallMarioTurningRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateSmallMarioTurningRightSprite();
        }
