...
{
    class SmallMarioWinningLegDownRightState : IPlayerState
    {
        ...
        public SmallMarioWinningLegDownRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateSmallMarioWinningLegDownRightSprite();
            spriteFrameDelay = 0;
        }
        ...
        public void PoleSequence()
        {
            if(!MarioMovement.IsGrounded)
            {
                ...
                {
                    mario.State = new SmallMarioWinningLegUpRightState(mario);
                    spriteFrameDelay = 0;
                }
            }
        }
        ...
        {
            mario.State = new SmallMarioWinningLegDownLeftState(mario);
        }
