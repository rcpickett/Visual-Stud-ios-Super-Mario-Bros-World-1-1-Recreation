...
{
    class SmallMarioWinningLegDownLeftState : IPlayerState
    {
        ...
        public SmallMarioWinningLegDownLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateSmallMarioWinningLegDownLeftSprite();
        }
