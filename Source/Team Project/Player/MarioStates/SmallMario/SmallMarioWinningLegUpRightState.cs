...
{
    class SmallMarioWinningLegUpRightState : IPlayerState
    {
        ...
        public SmallMarioWinningLegUpRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateSmallMarioWinningLegUpRightSprite();
            spriteFrameDelay = Value.Zero;
        }
        ...
        public void PoleSequence()
        {
            ...
            {
                spriteFrameDelay += Value.One;
                if (spriteFrameDelay == Value.Five)
                {
        ...
        {
            mario.State = new SmallMarioWinningLegUpLeftState(mario);
        }
        ...
        public void CollectItem(IItem item)
        {
            ...
            else if (item is SuperMushroom || item is FireFlower)
            {
