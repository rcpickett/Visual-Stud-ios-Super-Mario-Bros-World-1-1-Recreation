...
{
    class SmallMarioWinningLegUpLeftState : IPlayerState
    {
        ...
        public SmallMarioWinningLegUpLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateSmallMarioWinningLegUpLeftSprite();
        }
