...
{
    public class IceMarioIceballLeftState : IPlayerState
    {
        ...
        public IceMarioIceballLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateIceMarioIceballLeftSprite();
            ProjectileTracker.CreateIceball(new Vector2(mario.Location.X, mario.Location.Y + 9), false, mario);
