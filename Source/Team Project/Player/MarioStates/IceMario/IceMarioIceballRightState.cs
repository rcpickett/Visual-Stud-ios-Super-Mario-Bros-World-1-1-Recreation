...
{
    public class IceMarioIceballRightState : IPlayerState
    {
        ...
        public IceMarioIceballRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateIceMarioIceballRightSprite();
            ProjectileTracker.CreateIceball(new Vector2(mario.Location.X + mario.Rectangle.Width, mario.Location.Y + 9), true, mario);
