...
{
    class IceMarioWinningArmDownLeftState : IPlayerState
    {
        ...
        public IceMarioWinningArmDownLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateIceMarioWinningArmDownLeftSprite();
        }
        ...
        public void EndAnimation()
        {
            ...
            mario.State = new IceMarioRunningLeftState(mario);
        }
