...
{
    public class IceMarioGoingIntoPipeRightState : IPlayerState
    {
        ...
        public IceMarioGoingIntoPipeRightState(Mario m, Vector2 newL, Vector2 newCL)
        {
            SoundManager.PlayMarioPipeOrPowerDownSound();
            mario = m;
            sprite = SpriteFactory.CreateIceMarioRunningRightSprite();
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (timer >= 1000)
            {
                ...
                mario.State = new IceMarioComingOutOfPipeState(mario);
            }
