...
{
    class IceMarioRunningRightState : IPlayerState
    {
        ...
        public IceMarioRunningRightState(Mario m)
        {
            sprite = (MarioRunningSprite)SpriteFactory.CreateIceMarioRunningRightSprite();
            mario = m;
        }

        public void Left()
        {
            mario.State = new IceMarioTurningLeftState(mario);
        }
        ...
        public void Up()
        {
            ...
            if (MarioMovement.IsJumping)
                mario.State = new IceMarioJumpingRightState(mario);
        }
        ...
        public void B()
        {
            ...
            {
                mario.State = new IceMarioIceballRightState(mario);
        ...
        public void PipeCollision(IPipe pipe, CollisionDetector.CollisionType collision, Vector2 marioLocation, Vector2 camLocation)
        {
            if (IsWarping(marioLocation))
            {
                ...
                {
                    mario.State = new IceMarioGoingIntoPipeRightState(mario, marioLocation, camLocation);
                }
            }
