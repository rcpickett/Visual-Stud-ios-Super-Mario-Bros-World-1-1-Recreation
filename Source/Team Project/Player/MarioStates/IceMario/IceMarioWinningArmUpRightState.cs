...
{
    class IceMarioWinningArmUpRightState : IPlayerState
    {
        ...
        public IceMarioWinningArmUpRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateIceMarioWinningArmUpRightSprite();
            spriteFrameDelay = 0;
        }
        ...
        public void PoleSequence()
        {
            if(!MarioMovement.IsGrounded)
            {
                ...
                {
                    mario.State = new IceMarioWinningArmDownRightState(mario);
                    spriteFrameDelay = 0;
                }
            }
        }
        ...
        {
            mario.State = new IceMarioWinningArmUpLeftState(mario);
        }
