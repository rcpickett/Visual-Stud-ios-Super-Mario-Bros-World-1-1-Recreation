...
{
    public class BigMarioCrouchingLeftState : IPlayerState
    {
        ...
        public BigMarioCrouchingLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateBigMarioCrouchingLeftSprite();
        }
        ...
        public void Right()
        {
            mario.State = new BigMarioCrouchingRightState(mario);
        }
        ...
        public void PipeCollision(IPipe pipe, CollisionDetector.CollisionType collision, Vector2 marioLocation, Vector2 camLocation)
        {
            if (IsWarping(marioLocation) && IsInMiddleOfPipe(mario, pipe))
            {
                ...
                {
                    mario.State = new BigMarioGoingDownPipeLeftState(mario, marioLocation, camLocation);
                }
            }
