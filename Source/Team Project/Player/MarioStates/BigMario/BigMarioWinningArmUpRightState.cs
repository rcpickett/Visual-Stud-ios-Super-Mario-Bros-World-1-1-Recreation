...
{
    class BigMarioWinningArmUpRightState : IPlayerState
    {
        ...
        public BigMarioWinningArmUpRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateBigMarioWinningArmUpRightSprite();
            spriteFrameDelay = 0;
        }
        ...
        public void PoleSequence()
        {
            if(!MarioMovement.IsGrounded)
            {
                ...
                {
                    mario.State = new BigMarioWinningArmDownRightState(mario);
                    spriteFrameDelay = 0;
                }
            }
        }
        ...
        {
            mario.State = new BigMarioWinningArmUpLeftState(mario);
        }
