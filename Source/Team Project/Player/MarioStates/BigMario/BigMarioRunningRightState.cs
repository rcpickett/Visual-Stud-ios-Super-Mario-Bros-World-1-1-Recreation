...
{
    class BigMarioRunningRightState : IPlayerState
    {
        ...
        public BigMarioRunningRightState(Mario m)
        {
            sprite = (MarioRunningSprite)SpriteFactory.CreateBigMarioRunningRightSprite();
            mario = m;
        }

        public void Left()
        {
            mario.State = new BigMarioTurningLeftState(mario);
        }
