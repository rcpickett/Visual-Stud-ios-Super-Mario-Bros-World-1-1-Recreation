...
{
    public class BigMarioGoingIntoPipeRightState : IPlayerState
    {
        ...
        public BigMarioGoingIntoPipeRightState(Mario m, Vector2 newL, Vector2 newCL)
        {
            SoundManager.PlayMarioPipeOrPowerDownSound();
            mario = m;
            sprite = SpriteFactory.CreateBigMarioRunningRightSprite();
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (timer >= 1000)
            {
                ...
                mario.State = new BigMarioComingOutOfPipeState(mario);
            }
