...
{
    class BigMarioWinningArmDownRightState : IPlayerState
    {
        ...
        public BigMarioWinningArmDownRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateBigMarioWinningArmDownRightSprite();
            spriteFrameDelay = 0;
        }
        ...
        {
            mario.State = new BigMarioWinningArmDownLeftState(mario);
        }
