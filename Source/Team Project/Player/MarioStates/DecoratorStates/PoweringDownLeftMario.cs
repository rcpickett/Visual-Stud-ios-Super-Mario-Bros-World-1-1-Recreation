...
{
    public class PoweringDownLeftMario : IPlayer
    {
        private Mario mario;
        ...
        public PoweringDownLeftMario(Mario m)
        {
            mario = m;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedTimeS >= delayTimeS)
            {
                ...
                switch (state % 3)
                {
                    ...
                    case 1:
                        mario.State = new BigMarioSwimIdleLeftState(mario);
                        mario.Location = new Vector2(mario.Location.X, mario.Location.Y + 3);
                        break;

                    case 2:
                        mario.State = new SmallMarioSwimIdleLeftState(mario);
