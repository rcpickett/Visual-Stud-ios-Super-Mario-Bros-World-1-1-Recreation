...
{
    class FireMarioWinningArmDownRightState : IPlayerState
    {
        ...
        public FireMarioWinningArmDownRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateFireMarioWinningArmDownRightSprite();
            spriteFrameDelay = 0;
        }
        ...
        {
            mario.State = new FireMarioWinningArmDownLeftState(mario);
        }
