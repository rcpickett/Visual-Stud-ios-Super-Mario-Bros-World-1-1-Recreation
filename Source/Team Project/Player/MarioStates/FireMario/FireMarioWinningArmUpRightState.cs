...
{
    class FireMarioWinningArmUpRightState : IPlayerState
    {
        ...
        public FireMarioWinningArmUpRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateFireMarioWinningArmUpRightSprite();
            spriteFrameDelay = 0;
        }
        ...
        public void PoleSequence()
        {
            if(!MarioMovement.IsGrounded)
            {
                ...
                {
                    mario.State = new FireMarioWinningArmDownRightState(mario);
                    spriteFrameDelay = 0;
                }
            }
        }
        ...
        {
            mario.State = new FireMarioWinningArmUpLeftState(mario);
        }
