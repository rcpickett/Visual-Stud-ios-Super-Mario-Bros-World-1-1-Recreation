...
{
    class FireMarioRunningLeftState : IPlayerState
    {
        ...
        public FireMarioRunningLeftState(Mario m)
        {
            sprite = (MarioRunningSprite)SpriteFactory.CreateFireMarioRunningLeftSprite();
            mario = m;
        }
        ...
        public void Right()
        {
            mario.State = new FireMarioTurningRightState(mario);
        }
        ...
        public void Up()
        {
            ...
            if (MarioMovement.IsJumping)
                mario.State = new FireMarioJumpingLeftState(mario);
        }

        public void Down()
        {
            mario.State = new FireMarioCrouchingLeftState(mario);
        ...
        public void B()
        {
            ...
            {
                mario.State = new FireMarioFireballLeftState(mario);
        ...
        public void EndAnimation()
        {
            ...
            {
                mario.State = new FireMarioRunningRightState(mario);
            }
        }
