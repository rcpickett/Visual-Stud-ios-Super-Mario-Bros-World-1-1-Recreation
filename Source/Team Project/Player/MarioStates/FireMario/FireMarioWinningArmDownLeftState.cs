...
{
    class FireMarioWinningArmDownLeftState : IPlayerState
    {
        ...
        public FireMarioWinningArmDownLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateFireMarioWinningArmDownLeftSprite();
        }
