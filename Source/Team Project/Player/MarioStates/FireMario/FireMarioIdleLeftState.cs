...
{
    public class FireMarioIdleLeftState : IPlayerState
    {
        ...
        public FireMarioIdleLeftState(Mario m)
        {
            sprite = SpriteFactory.CreateFireMarioIdleLeftSprite();
            mario = m;
        }

        public void Left()
        {
            mario.State = new FireMarioRunningLeftState(mario);
        }
