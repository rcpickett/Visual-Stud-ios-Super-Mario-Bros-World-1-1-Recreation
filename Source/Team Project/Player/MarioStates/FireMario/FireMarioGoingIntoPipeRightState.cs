...
{
    public class FireMarioGoingIntoPipeRightState : IPlayerState
    {
        ...
        public FireMarioGoingIntoPipeRightState(Mario m, Vector2 newL, Vector2 newCL)
        {
            SoundManager.PlayMarioPipeOrPowerDownSound();
            mario = m;
            sprite = SpriteFactory.CreateFireMarioRunningRightSprite();
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (timer >= 1000)
            {
                ...
                mario.State = new FireMarioComingOutOfPipeState(mario);
            }
