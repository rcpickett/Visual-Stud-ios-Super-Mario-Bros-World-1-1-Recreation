...
{
    public class FireMarioFireballRightState : IPlayerState
    {
        ...
        public FireMarioFireballRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateFireMarioFireballRightSprite();
            ProjectileTracker.CreateFireball(new Vector2(mario.Location.X + mario.Rectangle.Width, mario.Location.Y + 9), true, mario);
