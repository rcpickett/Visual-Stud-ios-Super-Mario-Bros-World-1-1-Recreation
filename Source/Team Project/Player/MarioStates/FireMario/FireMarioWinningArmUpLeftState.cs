...
{
    class FireMarioWinningArmUpLeftState : IPlayerState
    {
        ...
        public FireMarioWinningArmUpLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateFireMarioWinningArmUpLeftSprite();
        }
