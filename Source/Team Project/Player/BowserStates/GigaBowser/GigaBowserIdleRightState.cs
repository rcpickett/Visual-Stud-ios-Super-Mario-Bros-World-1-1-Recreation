...
{
    public class GigaBowserIdleRightState : IPlayerState
    {
        ...
        public GigaBowserIdleRightState(Mario m)
        {
            sprite = SpriteFactory.CreateGigaBowserIdleRightSprite();
            mario = m;
        }
        ...
        public void Up()
        {
            ...
            if (MarioMovement.IsJumping)
                mario.State = new GigaBowserJumpingRightState(mario);
        }
        ...
        public void B()
        {
            ...
            {
                mario.State = new GigaBowserFlameRightState(mario);
