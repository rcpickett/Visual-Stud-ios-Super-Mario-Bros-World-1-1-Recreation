...
{
    class GigaBowserJumpingLeftState : IPlayerState
    {
        ...
        public GigaBowserJumpingLeftState(Mario m)
        {
            sprite = (BowserRunningSprite)SpriteFactory.CreateGigaBowserRunningLeftSprite();
            mario = m;
        }
