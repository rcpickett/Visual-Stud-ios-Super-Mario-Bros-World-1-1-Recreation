...
{
    public class GigaBowserFlameLeftState : IPlayerState
    {
        ...
        public GigaBowserFlameLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateGigaBowserBreathLeftSprite();
            ProjectileTracker.CreateMF(new Vector2(mario.Location.X-16, 0), false, mario);
