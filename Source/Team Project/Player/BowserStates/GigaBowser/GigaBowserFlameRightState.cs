...
{
    public class GigaBowserFlameRightState : IPlayerState
    {
        ...
        public GigaBowserFlameRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateGigaBowserBreathRightSprite();
            ProjectileTracker.CreateMF(new Vector2(mario.Location.X + mario.Rectangle.Width,0), true, mario);
            SoundManager.PlayMFStartSound();
        }
