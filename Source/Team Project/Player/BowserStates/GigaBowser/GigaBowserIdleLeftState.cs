...
{
    public class GigaBowserIdleLeftState : IPlayerState
    {
        ...
        public GigaBowserIdleLeftState(Mario m)
        {
            sprite = SpriteFactory.CreateGigaBowserIdleLeftSprite();
            mario = m;
        }

        public void Left()
        {
            mario.State = new GigaBowserRunningLeftState(mario);
        }
        ...
        public void Up()
        {
            ...
            if (MarioMovement.IsJumping)
                mario.State = new GigaBowserJumpingLeftState(mario);
        }
        ...
        public void B()
        {
            ...
            {
                mario.State = new GigaBowserFlameLeftState(mario);
