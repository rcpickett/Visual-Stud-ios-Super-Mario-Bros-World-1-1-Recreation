...
{
    public class BowserEmberRightState : IPlayerState
    {
        ...
        public BowserEmberRightState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateSmallBowserBreathRightSprite();
            ProjectileTracker.CreateEmber(new Vector2(mario.Location.X + mario.Rectangle.Width, mario.Location.Y + 15), true, mario);
