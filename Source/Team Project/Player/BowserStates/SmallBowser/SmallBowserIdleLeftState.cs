...
{
    public class SmallBowserIdleLeftState : IPlayerState
    {
        ...
        public SmallBowserIdleLeftState(Mario m)
        {
            sprite = SpriteFactory.CreateSmallBowserIdleLeftSprite();
            mario = m;
        }

        public void Left()
        {
            mario.State = new SmallBowserRunningLeftState(mario);
        }
        ...
        public void Up()
        {
            ...
            if (MarioMovement.IsJumping)
                mario.State = new SmallBowserJumpingLeftState(mario);
        }
        ...
        public void B()
        {
            ...
            {
                mario.State = new BowserEmberLeftState(mario);
