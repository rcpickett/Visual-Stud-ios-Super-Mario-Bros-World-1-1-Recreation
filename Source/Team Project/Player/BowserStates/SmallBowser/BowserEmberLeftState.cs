...
{
    public class BowserEmberLeftState : IPlayerState
    {
        ...
        public BowserEmberLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateSmallBowserBreathLeftSprite();
            ProjectileTracker.CreateEmber(new Vector2(mario.Location.X, mario.Location.Y + 15), false, mario);
