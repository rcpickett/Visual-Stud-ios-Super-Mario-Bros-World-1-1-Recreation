...
{
    class SmallBowserRunningLeftState : IPlayerState
    {
        ...
        public SmallBowserRunningLeftState(Mario m)
        {
            sprite = (BowserRunningSprite)SpriteFactory.CreateBowserRunningLeftSprite();
            mario = m;
        }
