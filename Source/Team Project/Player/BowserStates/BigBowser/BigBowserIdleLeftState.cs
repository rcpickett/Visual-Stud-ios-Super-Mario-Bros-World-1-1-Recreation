...
{
    public class BigBowserIdleLeftState : IPlayerState
    {
        ...
        public BigBowserIdleLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateBigBowserIdleLeftSprite();
        }

        public void Left()
        {
            mario.State = new BigBowserRunningLeftState(mario);
        }
        ...
        public void Up()
        {
            ...
            if (MarioMovement.IsJumping)
                mario.State = new BigBowserJumpingLeftState(mario);
        }
        ...
        public void B()
        {
            ...
            {
                mario.State = new BigBowserFlameLeftState(mario);
        ...
        public void CollectItem(IItem item)
        {
            ...
            {
                mario.State = new FiringUpLeftBowser(mario);
            }
