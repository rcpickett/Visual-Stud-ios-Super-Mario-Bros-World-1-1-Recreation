...
{
    class BigBowserRunningLeftState : IPlayerState
    {
        ...
        public BigBowserRunningLeftState(Mario m)
        {
            sprite = (BowserRunningSprite)SpriteFactory.CreateBigBowserRunningLeftSprite();
            mario = m;
        }
