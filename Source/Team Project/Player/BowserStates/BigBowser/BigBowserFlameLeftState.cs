...
{
    public class BigBowserFlameLeftState : IPlayerState
    {
        ...
        public BigBowserFlameLeftState(Mario m)
        {
            mario = m;
            sprite = SpriteFactory.CreateBigBowserBreathLeftSprite();
            ProjectileTracker.CreateFF(new Vector2(mario.Location.X, mario.Location.Y + 15), false, mario);
