...
{
    public class Iceball : IProjectile
    {
        ...
        public Iceball(Vector2 loc, bool facingRight, IPlayer m)
        {
            Location = loc;
            sprite = SpriteFactory.CreateIceballSprite();
            if (facingRight)
            {
        ...
        public void CollisionResponseWithEnemy(IPlayer m, IEnemy enemy, CollisionDetector.CollisionType collision)
        {
            ...
            {
                ProjectileTracker.ExplodeIceball(this);
