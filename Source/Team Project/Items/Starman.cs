...
namespace Team_Project
{
    public class Starman : IItem
    {
        ...
        public Starman(Vector2 loc, Block block)
        {
            Location = loc;
            sprite = SpriteFactory.CreateStarmanSprite();
            Movement = new Vector2(Speed.One, Speed.NegativeThreeAndOneFifth);
