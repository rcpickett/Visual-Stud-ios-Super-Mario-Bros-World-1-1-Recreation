...
{
    public class LPipeRightIn : IPipe
    {
        private IAnimatedSprite lPipeRightIn;
        ...
        public Rectangle Rectangle { get { return new Rectangle((int)location.X, (int)location.Y+Value.Two, (int)lPipeRightIn.TextureDimension.X, (int)lPipeRightIn.TextureDimension.Y-Value.Four); } }

        public LPipeRightIn(Vector2 location, string mWL, Level l)
        {
            this.location = location;
            lPipeRightIn = SpriteFactory.CreateLLeftInPipe();
            level = l;
        ...
        {
            lPipeRightIn.Update(gameTime);
        }

        public void Draw(SpriteBatch spriteBatch)
        {
            lPipeRightIn.Draw(spriteBatch, location, Color.White);
        }
